...
public class SistemaPessoa {
    ...
    public static void main(String[] args) {
        ...
        main(args, versaoSistema, nomeUsuario, dataAcesso);
    }

    public static void main(String[] args, String versaoSistema, String nomeUsuario, String dataAcesso) {
        main(args, versaoSistema, nomeUsuario, dataAcesso, 800, 800);
    }

    public static void main(String[] args, String versaoSistema, String nomeUsuario, String dataAcesso, int width, int height) {
